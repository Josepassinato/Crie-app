...
import { MediaType, ProductFormData, UploadedImage } from '../types.ts';
...
// Fix: Import generateNarrationScript and generateCreativeSuggestions from geminiService.
import { generateNarrationScript, generateCreativeSuggestions } from '../services/geminiService.ts';
...
export const ProductInputForm: React.FC<ProductInputFormProps> = ({ formState, setFormState, outputType, setOutputType, onSubmit, onClear, isLoading, onOpenSaveModal }) => {
    ...
    const handleGenerateAISuggestions = async () => {
        ...
        try {
            const suggestions = await generateCreativeSuggestions(
                {
                    ...
                    marketingVibe: formState.marketingVibe,
            ...
            setFormState((prev: ProductFormData) => ({
                ...prev,
